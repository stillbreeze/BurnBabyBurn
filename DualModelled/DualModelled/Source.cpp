...
const string windowName5 = "Extracted frame";
...
int main(int argc, char* argv[])
{
	...
	while (1){
		...
		namedWindow(windowName4, 0);
		namedWindow(windowName5, 0);

		resizeWindow(windowName, 2000, 2000);
		resizeWindow(windowName1, 2000, 2000);
		resizeWindow(windowName2, 2000, 2000);
		resizeWindow(windowName3, 2000, 2000);
		resizeWindow(windowName4, 2000, 2000);
		resizeWindow(windowName5, 2000, 2000);
